    ...
    if (ob == "polska") {
        ...
        if (lata != null) {
            ...
            if (prs > 34) {
                ...
                alert("Nie możesz ubiegać się o fotel prezydenta(Jesteś za młody).");
            }
            ;
        }
        else {
        ...
        alert("Nie możesz ubiegać się o fotel prezydenta(Nie posiadasz obywatelstwa polskiego).");
    }
}
function cztery() {
    ...
    if (trasa != null) {
        ...
        if (trasaInt > 0 && trasaInt <= 15) {
            ...
            alert("Niepoprawna długość trasy");
    }
}
